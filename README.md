...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-w69q2wq.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-w69q2wq.containers.anotherwebservice.com/
...
```
git clone git@github.com:gecteldjazairsuisse/container-w69q2wq.git
cd container-w69q2wq
```
...
```
docker attach container-w69q2wq
```
